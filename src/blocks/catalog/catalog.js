              ...
              <div class="catalog__popup-benefits">
                ...
                <ul class="catalog__popup-benefits-list">
                  ...
                  <li class="catalog__popup-benefits-item">
                    <div class="catalog__popup-benefits-card">
                      <span class="catalog__popup-benefits-icon">
                        <img class="catalog__popup-benefits-image" src="imgs/catalog/icons/catalog--4.svg" alt="">
                      </span>
                      <span>Лёгкий уход</span>
                    </div>
                  </li>
                  <li class="catalog__popup-benefits-item">
                    <div class="catalog__popup-benefits-card">
                      <span class="catalog__popup-benefits-icon">
                        <img class="catalog__popup-benefits-image" src="imgs/catalog/icons/catalog--5.svg" alt="">
                      </span>
                      <span>Антиотпечаток</span>
                    </div>
                  </li>
                  <li class="catalog__popup-benefits-item">
                    <div class="catalog__popup-benefits-card">
                      <span class="catalog__popup-benefits-icon">
                        <img class="catalog__popup-benefits-image" src="imgs/catalog/icons/catalog--6.svg" alt="">
                      </span>
                      <span>Экологичное</span>
                    </div>
                  </li>
                </ul>
              </div>
